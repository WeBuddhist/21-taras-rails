...
| འབྱུང་པོ | spirits | **鬼神** | new (no source had it) | 1-6 | འབྱུང་པོ (bhūta). Classical and DharmaMitra both write the transliteration 部多, which a general reader cannot parse. 鬼神 is the ordinary Chinese word for spirits and keeps it distinct from 邪魅 (གདོན). |
