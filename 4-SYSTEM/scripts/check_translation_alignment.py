#!/usr/bin/env python3
"""check_translation_alignment.py — prove that every translation mirrors the Tibetan, structurally.
...
PARSER = VAULT / "4-SYSTEM/scripts/parser-root-text/parser.py"
PAYLOAD_DIR = VAULT / "4-SYSTEM/scripts/parser-root-text/output"
DEFAULT_ROOT = VAULT / "1-SOURCES/Text/bo-སྒྲོལ་མ་ཉེར་གཅིག་ལ་བསྟོད་པ།.md"
...
def main():
    ...
    ap.add_argument("translations", nargs="*", help="translation notes (default: every machine track)")
