...
has (4-SYSTEM/scripts/linter-root-text + parser-root-text). It shells out to
...
appends a receipt to 4-SYSTEM/scripts/upload_ledger.json after every call —
...
Usage (from the vault root):
    python3 4-SYSTEM/scripts/upload_translation.py "<translation.md>"              # dry run
    python3 4-SYSTEM/scripts/upload_translation.py "<translation.md>" --execute    # after human confirmation
    python3 4-SYSTEM/scripts/upload_translation.py "<translation.md>" --verify     # GET everything back
"""
...
SCRIPTS = VAULT / "4-SYSTEM" / "scripts"
LINTER = SCRIPTS / "linter-root-text" / "lint_text_input.py"
LINT_OUT = SCRIPTS / "linter-root-text" / "output"
PARSER = SCRIPTS / "parser-root-text" / "parser.py"
PARSE_OUT = SCRIPTS / "parser-root-text" / "output"
LEDGER = SCRIPTS / "upload_ledger.json"
