...
Every slot article is titled `སྒྲོལ་མ་<epithet>།`, prefix first, no exceptions — so the whole
series sorts and prefix-searches together on the wiki. Each article's opening bolded term is
kept identical to its title.
...
| Slot | Title | State |
|---|---|---|
| `origin` | [སྒྲོལ་མའི་ལོ་རྒྱུས།](https://bo.wikipedia.org/w/index.php?curid=28182) | 🟢 live · 28182 |
| `structure-benefits` | [ཕྱག་འཚལ་ཉེར་གཅིག་གིས་བསྟོད་པ།](https://bo.wikipedia.org/w/index.php?curid=28183) | 🟢 live · 28183 |
...
**Series prefix.** Every one of the 21 slot articles is titled སྒྲོལ་མ་<epithet>། — the prefix goes at the front without exception, so the whole series sorts and prefix-searches together on the wiki. Where the attested epithet is itself of the form X་གྱི་སྒྲོལ་མ, it is normalised to སྒྲོལ་མ་X། — the move already used live for tara-03 (གསེར་མདོག་ཅན་གྱི་སྒྲོལ་མ → སྒྲོལ་མ་གསེར་མདོག་ཅན།). Honorifics (རྗེ་བཙུན་མ་, རྗེ་བཙུན་) and any ལྷ་མོ་ element are stripped. Nothing is ever added: no syllable appears in a title that is not in the attested epithet.
...
**Choosing among competing names.** Where the commentaries name a slot differently — they do for most of them — the epithet is chosen by, in order: (1) widest attestation, the name given by the most commentaries; (2) on a tie, the name the article's own lead sentence or root verse already carries, so that title and article agree; (3) still tied, the form that reads as a name rather than as a description of the deity's activity, preferring the shorter and the ...མ ending the series uses. Every chosen epithet was checked to appear verbatim in its own article before being used. Recorded per slot as `decision_basis`; the rejected candidates are kept below so the choice stays auditable and the divergence itself is never lost — it remains documented in each article's མཚན་གྱི་ངེས་ཚིག section, which the title does not overwrite.

**Lead term stays in sync.** Each article's opening bolded term is kept identical to its title (minus the final shad, plus a tsheg inside the bold, per the live tara-01 form '''སྒྲོལ་མ་མྱུར་མ་དཔའ་མོ་'''ནི་). Updated for all 18 unpublished slots on 2026-08-21. tara-02 is the one live article where the two still differ.
...
on name-form. Rejected candidates are kept so the choice stays auditable; the divergence itself
stays documented in each article's `མཚན་གྱི་ངེས་ཚིག` section.

| Slot | Decided title | Basis | Attested candidates (commentators) |
|---|---|---|---|
| `tara-04` | སྒྲོལ་མ་གཙུག་ཏོར་རྣམ་པར་རྒྱལ་མ། | convergent | **གཙུག་ཏོར་རྣམ་པར་རྒྱལ་མ** — article lead term, bstan-'dzin-don-bzang (གཙུག་ཏོར་རྣམ་རྒྱལ་མ)<br>གཙུག་ཏོར་རྒྱན་པའི་སྒྲོལ་མ — gendun-drub<br>འཆི་མེད་ཚེ་སྒྲུབ — palden-sherab, sangye-nyentrul, tsultrim-namdak |
| `tara-05` | སྒྲོལ་མ་ཧཱུཾ་སྒྲ་སྒྲོག་མ། | tie-broken | **རྗེ་བཙུན་མ་ཧཱུཾ་སྒྲ་སྒྲོག་མ** — yama-sonam, gendun-drub, tenzin-dhonzang<br>དབང་སྡུད་རིགས་བྱེད་ལྷ་མོ — palden-sherab, sangye-nyentrul, tsultrim-namdak |
| `tara-06` | སྒྲོལ་མ་གདོན་རིགས་རྣམ་པར་འཇོམས་པ་འཇིགས་བྱེད་ཆེན་མོ། | plurality | འཇིག་རྟེན་གསུམ་ལས་རྣམ་པར་རྒྱལ་བ — yama-sonam, tenzin-dhonzang<br>**གདོན་རིགས་རྣམ་པར་འཇོམས་པ་འཇིགས་བྱེད་ཆེན་མོ** — palden-sherab, tsultrim-namdak, sungrab-tulku |
| `tara-07` | སྒྲོལ་མ་གཞན་གྱིས་མི་ཐུབ་མ། | plurality | གཞན་མཐུ་འཇོམས་མ — yama-sonam, tenzin-dhonzang<br>**དམག་དང་ཐོག་སེར་འཇོམས་མ་གཏུམ་མོ་གཞན་གྱིས་མི་ཐུབ་མ** — palden-sherab, article lead term<br>གཞན་འཇོམས་མ — sungrab-tulku<br>རྒོལ་བ་འཇོམས་པའི་སྒྲོལ་མ — gendun-drub |
| `tara-08` | སྒྲོལ་མ་འཇིགས་པ་ཆེན་མོ། | convergent | **འཇིགས་པ་ཆེན་མོ** — article lead term, sungrab-tulku, drakpa-gyaltsen |
| `tara-09` | སྒྲོལ་མ་སེང་ལྡེང་ནགས། | plurality | **སེང་ལྡེང་ནགས་ཀྱི་སྒྲོལ་མ** — gendun-drub, palden-sherab, tsultrim-namdak<br>མཆོག་སྩོལ་མ — yama-sonam |
| `tara-10` | སྒྲོལ་མ་བདུད་དང་འཇིག་རྟེན་དབང་སྡུད་མ། | convergent | **བདུད་དང་འཇིག་རྟེན་དབང་སྡུད་མ** — article lead term, cone-pa<br>འཇིག་རྟེན་དབང་སྡུད་མ — tenzin-dhonzang<br>མྱ་ངན་སེལ་བའི་སྒྲོལ་མ — nyima-bepa sādhana |
| `tara-11` | སྒྲོལ་མ་ཕོངས་པ་ཀུན་སེལ། | article-carried | **ཕོངས་པ་ཀུན་སེལ** — tenzin-dhonzang, article lead term<br>ས་གཞི — taranatha<br>དགུག་པའི་སྒྲོལ་མ — gendun-drub |
| `tara-12` | སྒྲོལ་མ་བཀྲ་ཤིས་དོན་གྲུབ་མ། | convergent | **བཀྲ་ཤིས་དོན་གྲུབ་མ** — sangye-nyentrul, tsultrim-namdak, article lead term<br>བཀྲིས་ཐམས་ཅད་སྦྱིན་མ — yama-sonam<br>བཀྲ་ཤིས་དོན་བྱེད་སྒྲོལ་མ — palden-sherab |
| `tara-13` | སྒྲོལ་མ་མེ་ལྟར་འབར་བ། | article-carried | སྨིན་པར་བྱེད་པའི་སྒྲོལ་མ — gendun-drub, nyima-bepa via yama-sonam<br>**མེ་ལྟར་འབར་བའི་སྒྲོལ་མ** — cone-pa, tenzin-dhonzang<br>དགྲ་དཔུང་འཇོམས་མ — tsultrim-namdak |
| `tara-14` | སྒྲོལ་མ་ཁྲོ་གཉེར་གཡོ་བ། | convergent | **ཁྲོ་གཉེར་གཡོ་བའི་སྒྲོལ་མ** — gendun-drub<br>ཁྲོ་གཉེར་ཅན་གྱི་སྒྲོལ་མ — cone-pa<br>འགུགས་བྱེད་སྒྲོལ་མ — nyima-bepa via yama-sonam |
| `tara-15` | སྒྲོལ་མ་ཞི་བ་ཆེན་མོ། | convergent | **ཞི་བ་ཆེན་མོ** — article first-named, sungrab-tulku (རྗེ་བཙུན་སྒྲོལ་མ་ཞི་བ་ཆེན་མོ) |
| `tara-16` | སྒྲོལ་མ་ཆགས་པ་འཇོམས་པ། | convergent | **ཆགས་པ་འཇོམས་པའི་སྒྲོལ་མ** — gendun-drub, yama-sonam citing nyima-bepa, article lead term<br>དགྲ་འཇོམས་མའི་སྒྲོལ་མ — yama-sonam citing nyima-bepa |
| `tara-17` | སྒྲོལ་མ་དཔག་མེད་གནོན་མ། | plurality | **དཔག་མེད་གནོན་མ** — palden-sherab, sangye-nyentrul, tsultrim-namdak<br>བདེ་བ་སྒྲུབ་པའི་སྒྲོལ་མ — yama-sonam, gendun-drub<br>འཇིག་རྟེན་གསུམ་གཡོ་མ — tenzin-dhonzang, sungrab-tulku |
| `tara-18` | སྒྲོལ་མ་རྨ་བྱ་ཆེན་མོ། | plurality | **རྨ་བྱ་ཆེན་མོ** — palden-sherab, sangye-nyentrul, tsultrim-namdak<br>རྣམ་རྒྱལ་སྒྲོལ་མ — yama-sonam, gendun-drub<br>དུག་སེལ་མ — tenzin-dhonzang, sungrab-tulku |
| `tara-19` | སྒྲོལ་མ་མི་ཕམ་གཟི་བརྗིད་ཅན། | tie-broken | **མི་ཕམ་གཟི་བརྗིད་ཅན་གྱི་རྒྱལ་མོ** — palden-sherab, sangye-nyentrul, tsultrim-namdak<br>སྡུག་བསྔལ་སྲེག་ཅིང་སེལ་བ — yama-sonam, gendun-drub<br>སྡུག་བསྔལ་སེལ་མ — tenzin-dhonzang |
| `tara-20` | སྒྲོལ་མ་རི་ཁྲོད་ལོ་མ་གྱོན་མ། | plurality | **རི་ཁྲོད་ལོ་མ་གྱོན་མ** — palden-sherab, sangye-nyentrul, tsultrim-namdak<br>དངོས་གྲུབ་འབྱུང་གནས — yama-sonam, gendun-drub |
| `tara-21` | སྒྲོལ་མ་འོད་ཟེར་ཅན་མ། | plurality | **འོད་ཟེར་ཅན་མ** — palden-sherab, tsultrim-namdak<br>ཡོངས་སུ་རྫོགས་བྱེད་སྒྲོལ་མ — yama-sonam, gendun-drub<br>འཕྲིན་ལས་སྒྲུབ་མཛད་མ — tenzin-dhonzang<br>བླུ་བྱེད — sangye-nyentrul |

Bold marks the candidate the title was taken from.

### Why each contested slot went the way it did

- **tara-05** → སྒྲོལ་མ་ཧཱུཾ་སྒྲ་སྒྲོག་མ། — 3–3 split. Taken as the form that is a name rather than a name-plus-function-plus-ལྷ་མོ compound, and that carries the ...མ ending the rest of the series uses.
- **tara-06** → སྒྲོལ་མ་གདོན་རིགས་རྣམ་པར་འཇོམས་པ་འཇིགས་བྱེད་ཆེན་མོ། — Four commentaries against three. Kept at full attested length rather than shortened to འཇིགས་བྱེད་ཆེན་མོ, which would sit one syllable from tara-08's སྒྲོལ་མ་འཇིགས་པ་ཆེན་མོ། and confuse readers. Longest title in the series.
- **tara-07** → སྒྲོལ་མ་གཞན་གྱིས་མི་ཐུབ་མ། — The three-commentary name runs to eleven syllables; གཞན་གྱིས་མི་ཐུབ་མ is its verbatim tail and is the element the rival གཞན་...འཇོམས་མ readings also share, so it is the one name every bloc supports.
- **tara-09** → སྒྲོལ་མ་སེང་ལྡེང་ནགས། — Attested as སེང་ལྡེང་ནགས་ཀྱི་སྒྲོལ་མ; normalised by the same move already used live for tara-03 (གསེར་མདོག་ཅན་གྱི་སྒྲོལ་མ → སྒྲོལ་མ་གསེར་མདོག་ཅན།).
- **tara-11** → སྒྲོལ་མ་ཕོངས་པ་ཀུན་སེལ། — Six commentaries, six names, no plurality. Falls to the name the article itself adopts — it states ཡིག་ཆ་འདིར་ཡང་མཚན་དེ་བཀོལ་ཡོད — which was already its lead term.
- **tara-13** → སྒྲོལ་མ་མེ་ལྟར་འབར་བ། — Three-way tie at two commentaries each. Falls to the reading that matches the root verse the article opens with (བསྐལ་པ་ཐ་མའི་མེ་ལྟར), so title and lead agree.
- **tara-17** → སྒྲོལ་མ་དཔག་མེད་གནོན་མ། — Three commentaries against two and two.
- **tara-18** → སྒྲོལ་མ་རྨ་བྱ་ཆེན་མོ། — Three commentaries against two and two. The name sits in གཞུང་ལུགས་སོ་སོའི་བཤད་པ, not in a མཚན་གྱི་ངེས་ཚིག section — this is the only slot article without one.
- **tara-19** → སྒྲོལ་མ་མི་ཕམ་གཟི་བརྗིད་ཅན། — 3–3 split. Taken as the name rather than the སྡུག་བསྔལ་... function description, then normalised by the tara-03 move (མི་ཕམ་གཟི་བརྗིད་ཅན་གྱི་རྒྱལ་མོ → སྒྲོལ་མ་མི་ཕམ་གཟི་བརྗིད་ཅན།) — the same X་ཅན་གྱི་<head> shape.
- **tara-20** → སྒྲོལ་མ་རི་ཁྲོད་ལོ་མ་གྱོན་མ། — Three commentaries against two.
- **tara-21** → སྒྲོལ་མ་འོད་ཟེར་ཅན་མ། — Three commentaries cluster on this name; one of them writes སྒྲོལ་མ་འོད་ཟེར་ཅན་མ verbatim, matching the title exactly.
