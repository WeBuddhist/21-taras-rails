...
- `W1` citation 'TARAC05_TRN_bo_segmented' is missing year and page
- `W2` citation 'TARAC05_TRN_bo_segmented' has no URL, so a reader cannot check it without the physical book
- `W3` section 'ངེས་ཚིག' rests on a single citation
- `W4` article is 703 ཚེག་བར long, below the 1500-syllable threshold

## Segment provenance

21 of 21 citations name the commentary block they came from.
