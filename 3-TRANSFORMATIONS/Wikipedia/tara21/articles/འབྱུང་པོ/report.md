...
- `V2` <ref> does not match any declared citation: མཛད་པ་པོ་གསང་བ། སྒྲོལ་མ་ཉེར་གཅིག་པའི་བསྟོད་འགྲེལ་འཕྲིན་ལས་ཆར…
...
- `W1` citation 'TARAC08_DTG_bo_segmented' is missing year and page
- `W2` citation 'TARAC08_DTG_bo_segmented' has no URL, so a reader cannot check it without the physical book
- `W4` article is 1379 ཚེག་བར long, below the 1500-syllable threshold
