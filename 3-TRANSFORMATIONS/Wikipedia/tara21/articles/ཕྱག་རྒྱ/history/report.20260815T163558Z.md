# Verification — ཕྱག་རྒྱ།

**FAIL**

## Errors

- `V2` <ref> does not match any declared citation: (མཚན་བྱང་མེད། ཡིག་ཆའི་ཁུངས་ཙམ་ལས་ངོས་འཛིན་ཐུབ།) སྒྲོལ་མའི་འག…
...
- `W1` citation 'TARAC17_TSN_bo_segmented' is missing year and page
- `W2` citation 'TARAC17_TSN_bo_segmented' has no URL, so a reader cannot check it without the physical book
- `W4` article is 1346 ཚེག་བར long, below the 1500-syllable threshold

## Segment provenance

16 of 16 citations name the commentary block they came from.
