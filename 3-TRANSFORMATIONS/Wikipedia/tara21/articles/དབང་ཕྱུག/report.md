...
- `W1` citation 'TARAC12_PDS_bo_segmented' is missing year and page
- `W2` citation 'TARAC12_PDS_bo_segmented' has no URL, so a reader cannot check it without the physical book
- `W4` article is 1216 ཚེག་བར long, below the 1500-syllable threshold

## Segment provenance

25 of 25 citations name the commentary block they came from.
...
- TARAC17_TSN_bo_segmented#^0-288: ཚོང་པ་རྣམས་ཀྱིས་ཚངས་པ་དང་། ཁྱབ་འཇུག །དབང་ཕྱུག་སོགས་ལ་གསོལ་བ་…
