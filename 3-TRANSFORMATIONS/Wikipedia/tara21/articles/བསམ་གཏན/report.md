# Verification — བསམ་གཏན

**FAIL**

## Quotations not found in source

- TARAC16_PSR_bo_segmented#^0-30: [missing] ཕྱག་འཚལ་གསེར་སྔོ་ཆུ་ནས་སྐྱེས་ཀྱི།། ...བཟོད་པ་བསམ་གཏན་སྤྱོད་ཡ…
- TARAC09_ANON_bo_segmented#^0-35: [missing] ten…

## Errors

- `V1` quotation not found verbatim in 'TARAC16_PSR_bo_segmented' (method=missing): ཕྱག་འཚལ་གསེར་སྔོ་ཆུ་ནས་སྐྱེས་ཀྱི།། ...བཟ…
- `V1` quotation not found verbatim in 'TARAC09_ANON_bo_segmented' (method=missing): ten
...
- `V9` non-Tibetan text in the article body: '8' — Latin letters and ASCII digits belong only inside <ref> URLs and template parameters (Tibetan numerals ༠–༩ in prose)
...
- `W1` citation 'TARAC17_TSN_bo_segmented' is missing year and page
- `W2` citation 'TARAC17_TSN_bo_segmented' has no URL, so a reader cannot check it without the physical book
- `W4` article is 1407 ཚེག་བར long, below the 1500-syllable threshold

## Segment provenance

13 of 15 citations name the commentary block they came from.
