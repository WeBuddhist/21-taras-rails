---
title: "zh — Dharmamitra primed with the Chinese word list"
...
rails_used: none
termbase: none
glossary: 0-INBOX/AI_translation/keyword-extraction-dharmamitra/zh/glossary-zh-general.tsv
status: draft
seeded: 2026-09-24
---

# Dharmamitra/zh-general — about this track

A **machine draft primed with the Chinese word list**, not a rails-governed translation track.

**Primed run.** Unlike a zero-shot baseline, every batch was given the locked Chinese terms of its verses
(`0-INBOX/AI_translation/keyword-extraction-dharmamitra/zh/glossary-zh-general.tsv`, built by `keyword-standardize`) as fixed terminology. The output has not been checked
against them or by a person. It is **draft 1** of the Chinese translation; the checked translation is
`3-TRANSFORMATIONS/Translations/zh-general/`.
