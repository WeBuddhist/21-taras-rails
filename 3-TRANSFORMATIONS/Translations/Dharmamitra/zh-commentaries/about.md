...
```bash
python3 ../Webuddhist-Skills/rails/machine-translate/scripts/dm_translate.py --source "<source>" --lang "modern chinese" --out 3-TRANSFORMATIONS/Translations/Dharmamitra/zh-commentaries --extra-fm 3-TRANSFORMATIONS/Translations/Dharmamitra/zh-commentaries/work/extra-fm-<stem>.json
python3 ../Webuddhist-Skills/rails/machine-translate/scripts/dm_translate.py --source "<source>" --lang "modern chinese" --out 3-TRANSFORMATIONS/Translations/Dharmamitra/zh-commentaries --extra-fm 3-TRANSFORMATIONS/Translations/Dharmamitra/zh-commentaries/work/extra-fm-<stem>.json --headings --heading-batch 8 --heading-style "$(cat 3-TRANSFORMATIONS/Translations/Dharmamitra/zh-commentaries/heading-style.md)"
```
