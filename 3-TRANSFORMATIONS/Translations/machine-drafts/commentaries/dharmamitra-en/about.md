...
```bash
python3 ../Webuddhist-Skills/rails/machine-translate/scripts/dm_translate.py --source "<source>" --lang "english" --out 3-TRANSFORMATIONS/Translations/machine-drafts/commentaries/dharmamitra-en --extra-fm 3-TRANSFORMATIONS/Translations/machine-drafts/commentaries/dharmamitra-en/work/extra-fm-<stem>.json
python3 ../Webuddhist-Skills/rails/machine-translate/scripts/dm_translate.py --source "<source>" --lang "english" --out 3-TRANSFORMATIONS/Translations/machine-drafts/commentaries/dharmamitra-en --extra-fm 3-TRANSFORMATIONS/Translations/machine-drafts/commentaries/dharmamitra-en/work/extra-fm-<stem>.json --headings --heading-batch 8 --heading-style "$(cat 3-TRANSFORMATIONS/Translations/machine-drafts/commentaries/dharmamitra-en/heading-style.md)"
```
