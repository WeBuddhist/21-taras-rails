...
# Run on your Mac, in Terminal:   bash 3-TRANSFORMATIONS/Translations/machine-drafts/primed/gemini-ne-general/run-ne-general.sh
...
OUT="3-TRANSFORMATIONS/Translations/machine-drafts/primed/gemini-ne-general"
