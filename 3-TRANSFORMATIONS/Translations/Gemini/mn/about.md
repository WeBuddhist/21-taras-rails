...
| 2026-09-17 | **Uploaded** to library.webuddhist.com under the existing text `7n1BhMN4FNkyaThaBtn3g`: edition `kVvsEydjnSZuHNRaB1jT2` (32 segments), alignment root→translation (32 identity pairs), TOC `Qm1EpYF6HU4BPGigNmZit` (1 root section + 4 subsections); read back and diffed against the payloads | live |
