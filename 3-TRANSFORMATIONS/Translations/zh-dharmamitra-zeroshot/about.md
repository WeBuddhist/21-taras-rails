...
| `praise-of-the-twenty-one-taras-zh.md` | The rendered translation, block-ID aligned to the source. |
...
python3 4-SYSTEM/Skills/dharmamitra-translate/scripts/dm_translate.py \
  --source "1-SOURCES/Text/སྒྲོལ་མ་ཉེར་གཅིག་གི་བསྟོད་པ།.md" --lang modern chinese
```
